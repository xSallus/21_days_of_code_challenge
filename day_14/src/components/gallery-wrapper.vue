...
<template>
  ...
  <div class="container">
    ...
    >
      <img src="../assets/caret-left.svg" alt="2 arrows together" />
    </button>

    <div class="gallery-wrapper" @scroll="onScroll">
      <GalleryItem v-for="user in users" :key="user.id" :user="user" />
    </div>
    ...
    >
      <img src="../assets/caret-right.svg" alt="2 arrows together" />
    </button>
  </div>
</template>
